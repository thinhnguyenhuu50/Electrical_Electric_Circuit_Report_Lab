...
\subsection{Câu 1: Danh sách cảm biến dòng điện}

\begin{enumerate}
    \item \textbf{TMCS1101}:
    \begin{itemize}
        \item \textbf{Dòng tối đa}: ±50A.
        ...
        \item \textbf{Hình ảnh}:
        \begin{center}
            \includegraphics[width=0.4\textwidth]{graphics/section5/tmcs1101.png}
        \end{center}
    \end{itemize}

    \item \textbf{INA226}:
    \begin{itemize}
        \item \textbf{Dòng tối đa}: ±36V.
        \item \textbf{Cách lấy giá trị}: Giao tiếp I2C.
        \item \textbf{Nguồn tham khảo}: \href{https://www.ti.com/product/INA226}{TI - INA226}.
        \item \textbf{Hình ảnh}:
        \begin{center}
            \includegraphics[width=0.4\textwidth]{graphics/section5/ina226.png}
        \end{center}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Nguồn tham khảo}: \href{https://www.analog.com/en/products/ltc2945.html}{Analog Devices - LTC2945}.
        \item \textbf{Hình ảnh}:
        \begin{center}
            % \includegraphics[width=0.4\textwidth]{ltc2945.jpg}
        \end{center}
    \end{itemize}
\end{enumerate}

\subsection{Câu 3:Trong hình 1.5, điện áp }
\subsection{Câu 5:}
\subsection{Câu 2:}
